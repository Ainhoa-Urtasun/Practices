...
plt.plot(['December 2023','February 2024'],[15,15+30-15],color='blue',ls='-.',label='Counterfactual')
plt.title('Training Evaluation',fontsize=16)
plt.ylabel('Labor productivity',fontsize=14)
plt.text(0.25,0,'[Training takes place during January 2024]',fontsize=14)

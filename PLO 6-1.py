...
tree.edge('n0','n1',label='High\n(0.6)')
tree.edge('n0','n2',label='Low\n(0.4)')
...
tree.edge('n1','n3',label='High')
tree.edge('n1','n4',label='Low')
...
tree.edge('n2','n5',label='High')
tree.edge('n2','n6',label='Low')
tree.node('n7',r'600\n-250',color='white',style='filled',fillcolor='white')
tree.node('n8',r'0\n0',color='white',style='filled',fillcolor='white')
tree.edge('n3','n7',label='Yes')
tree.edge('n3','n8',label='No')
